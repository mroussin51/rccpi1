# RCCPI AEO Integration Bundle

This bundle adds Answer‑Engine‑Optimized (AEO) pages to **rccpi.net** without changing your site’s look & feel.

## What’s included
- `/aeo/` — 14 HTML outline pages (answer‑first with JSON‑LD embedded) + an index
- `robots.txt` — references the sitemap
- `sitemap.xml` — lists `/aeo/` pages
...
unzip ~/Downloads/rccpi_aeo_integration_bundle.zip
...
```html
<li><a href="/aeo/">Guides &amp; How‑tos</a></li>
```
